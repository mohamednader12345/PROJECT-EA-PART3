...
def run_single_pso(seed_val, run_idx):
    ...
    print(f"\-- Run {run_idx} (seed {seed_val}) | linear_inertia --")
...
def plot_results(run_histories):
    shared_plot_individual_runs(run_histories, OUTPUT_DIR, NUM_GENERATIONS, "Linear Inertia")   
    return shared_plot_results(run_histories, OUTPUT_DIR, NUM_GENERATIONS, "Linear Inertia", algo_name="PSO")
